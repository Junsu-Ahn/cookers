...
//
//            // 새로운 회원 생성
//            Member member = memberService.whenSocialLogin(providerTypeCode, username, nickname, hit);
//
...
//
//            // 새로운 회원 생성
//            Member member = memberService.whenSocialLogin(providerTypeCode, username, name, hit);
//
//            List<GrantedAuthority> authorityList = new ArrayList<>();
//
//            return new CustomOAuth2User(member.getUsername(), member.getPassword(), authorityList);
